...
class TE_Scraper(Generic_Webdriver, SharedWebDriverState):
    ...
    **Init Parameters:** 
    ...
    BrowserType = Literal["chrome", "firefox"]  #Chrome still not working as of v0.2.2..
...
def scrape_chart(url: str = "https://tradingeconomics.com/united-states/business-confidence", 
    ...
    **Parameters**
    ...
    - browser (str): The browser to use, either 'chrome' or 'firefox'. Default is 'firefox'. Only firefox is supported at the moment (v0.2.2).
